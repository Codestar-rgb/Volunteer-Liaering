...
/**
 * EntityNexusBeam - Nexus Beam Projectile
 * Parasite entity of the projectile tier.
 */
public class EntityNexusBeam extends EntityParasiteBase {

    public EntityNexusBeam(EntityType<? extends Monster> type, Level level) {
        super(type, level);

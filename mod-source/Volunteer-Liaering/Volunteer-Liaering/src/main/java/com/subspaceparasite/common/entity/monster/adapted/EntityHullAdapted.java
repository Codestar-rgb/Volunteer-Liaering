 ...
 */
public class EntityHullAdapted extends EntityAdaptedBase {
    private static final double BASE_HEALTH = 110.0;
    ...
    public EntityHullAdapted(EntityType<? extends EntityAdaptedBase> entityType, Level worldIn) {

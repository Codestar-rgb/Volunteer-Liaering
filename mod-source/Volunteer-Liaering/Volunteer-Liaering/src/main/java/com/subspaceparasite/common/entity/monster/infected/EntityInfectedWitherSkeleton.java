...
/**
 * EntityInfectedWitherSkeleton - Infected Wither Skeleton
 * Parasite entity of the infected tier.
 */
public class EntityInfectedWitherSkeleton extends EntityInfectedBase {

    public EntityInfectedWitherSkeleton(EntityType<? extends Monster> type, Level level) {
        super(type, level);

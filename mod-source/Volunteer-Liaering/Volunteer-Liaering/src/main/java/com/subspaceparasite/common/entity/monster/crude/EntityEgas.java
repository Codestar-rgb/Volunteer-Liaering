...
/**
 * EntityEgas - Egas (Crude)
 * Parasite entity of the crude tier.
 */
public class EntityEgas extends EntityCrudeBase {

    public EntityEgas(EntityType<? extends Monster> type, Level level) {
        super(type, level);
        this.parasiteType = ParasiteType.THRALL;
    }

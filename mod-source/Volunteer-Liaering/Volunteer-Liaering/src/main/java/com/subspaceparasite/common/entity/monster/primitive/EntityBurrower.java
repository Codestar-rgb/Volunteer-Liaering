...
/**
 * EntityBurrower - Primitive Burrower
 * Parasite entity of the primitive tier.
 */
public class EntityBurrower extends EntityPrimitiveBase {

    public EntityBurrower(EntityType<? extends Monster> type, Level level) {
        super(type, level);
        this.parasiteType = ParasiteType.PRI_BURROWER;
    }

...
public class ModParticleTypes {
    ...
    // ================================================================
    // Additional particle types (consolidated from legacy ModParticles)
    // These were previously in client/particle/ModParticles.java which
    // was never registered, causing NPE at runtime.
    // ================================================================

    // === Corruption Particles ===
    public static final RegistryObject<SimpleParticleType> CORRUPTION = registerOverride("corruption");

    // === Bile Particles ===
    public static final RegistryObject<SimpleParticleType> BILE = register("bile");

    // === Infestation Particles ===
    public static final RegistryObject<SimpleParticleType> INFESTATION = registerOverride("infestation");

    // === Dissolve Particles ===
    public static final RegistryObject<SimpleParticleType> DISSOLVE = registerOverride("dissolve");

    // === Viral Particles ===
    public static final RegistryObject<SimpleParticleType> VIRAL = register("viral");

    // === Primordial Particles ===
    public static final RegistryObject<SimpleParticleType> PRIMORDIAL = register("primordial");

    // === Ancient Particles ===
    public static final RegistryObject<SimpleParticleType> ANCIENT = registerOverride("ancient");

    // === Legacy Nexus Particle (consolidated; NEXUS_BEAM and NEXUS_PULSE are more specific) ===
    public static final RegistryObject<SimpleParticleType> NEXUS_LEGACY = registerOverride("nexus");

...
public class EntityWorker extends EntityCrudeBase implements IParasite {
    ...
    @Override
    protected void dropCustomDeathLoot(DamageSource source, int lootingModifier, boolean recentlyHitIn) {
        super.dropCustomDeathLoot(source, lootingModifier, recentlyHitIn);

...
/**
 * EntityInfectedIronGolem - Infected Iron Golem
 * Parasite entity of the infected tier.
 */
public class EntityInfectedIronGolem extends EntityInfectedBase {

    public EntityInfectedIronGolem(EntityType<? extends Monster> type, Level level) {
        super(type, level);

...
/**
 * EntityRooterEpic - Rooter Stage IV
 * Parasite entity of the rooter tier.
 */
public class EntityRooterEpic extends EntityRooterBase {

    public EntityRooterEpic(EntityType<? extends Monster> type, Level level) {
        super(type, level);
        this.parasiteType = ParasiteType.ROOTER_SIV;
    }

...
/**
 * EntityInfectedStray - Infected Stray
 * Parasite entity of the infected tier.
 */
public class EntityInfectedStray extends EntityInfectedBase {

    public EntityInfectedStray(EntityType<? extends Monster> type, Level level) {
        super(type, level);

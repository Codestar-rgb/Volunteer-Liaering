...
/**
 * 分裂者 - Crude Stage Parasite
 * 特性：死亡分裂自我复制
 * 
 * 属性设计说明：
 * - MAX_HEALTH: 50.0 - 中等偏高血量，繁殖型单位
 * - MOVEMENT_SPEED: 0.24 - 中等移动速度
 * - ATTACK_DAMAGE: 8.0 - 中等攻击力
 */
public class EntityLesh extends EntityCrudeBase {

    public EntityLesh(EntityType<? extends EntityCrudeBase> entityType, Level worldIn) {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return EntityCrudeBase.createAttributes()
            .add(Attributes.MAX_HEALTH, 50.0D)      // 中等偏高血量
            .add(Attributes.MOVEMENT_SPEED, 0.24D)  // 中等速度

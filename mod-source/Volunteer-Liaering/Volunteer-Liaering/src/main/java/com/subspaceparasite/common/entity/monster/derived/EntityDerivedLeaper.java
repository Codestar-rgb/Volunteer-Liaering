...
/**
 * EntityDerivedLeaper - Derived Leaper
 * Parasite entity of the derived tier.
 */
public class EntityDerivedLeaper extends EntityDerivedBase {

    public EntityDerivedLeaper(EntityType<? extends Monster> type, Level level) {
        super(type, level);
        this.parasiteType = ParasiteType.KIRIN;
    }

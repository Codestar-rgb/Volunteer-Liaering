...
/**
 * EntityMindim - Mindim (Crude)
 * Parasite entity of the crude tier.
 */
public class EntityMindim extends EntityCrudeBase {

    public EntityMindim(EntityType<? extends Monster> type, Level level) {
        super(type, level);
        this.parasiteType = ParasiteType.INCOMPLETEFORM_SMALL;
    }

...
public class ItemModule extends Item {
    ...
    /** Module kind/type enumeration for categorization. */
    public enum ModuleKind {
        ADAPTER, BARRICADE, DYNAMO, EXOTHERMIC, FERROMAGNETIC,
        GRAVITATIONAL, HYPERTHREAT, INSULATING, KINETIC, LUMINOUS,
        MOTILE, NUTRIENT, OUTREACH, PHEROMONE, QUANTUM,
        RESILIENT, SIEGE, THORNIAN, UMBRELLA, VENOMOUS, WANDERER, XENOLITHIC
    }
    ...
    /**
     * Get the module kind for this item.
     * @param stack the item stack
     * @return the module kind
     */
    public ModuleKind getModuleKind(ItemStack stack) {
        try {
            return ModuleKind.valueOf(moduleType.toUpperCase());
        } catch (IllegalArgumentException e) {
            return ModuleKind.ADAPTER; // Default fallback
        }
    }
    ...
    public void appendHoverText(ItemStack stack, Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add(Component.literal(displayName + " Module").withStyle(color, ChatFormatting.ITALIC));

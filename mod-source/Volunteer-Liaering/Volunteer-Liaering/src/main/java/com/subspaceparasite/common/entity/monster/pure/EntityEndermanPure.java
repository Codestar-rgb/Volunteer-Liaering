...
/**
 * EntityEndermanPure - Pure Enderman
 * Parasite entity of the pure tier.
 */
public class EntityEndermanPure extends EntityPureBase {

    public EntityEndermanPure(EntityType<? extends Monster> type, Level level) {
        super(type, level);

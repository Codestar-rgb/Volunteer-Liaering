...
/**
 * Base class for custom mob effects in the SubspaceParasite mod.
 * <p>
 * <b>DEPRECATED:</b> Use {@link BaseSRPEffect} instead. This class is kept for
 * backward compatibility but all new effects should extend BaseSRPEffect which
 * provides more features (tick intervals, helper damage/heal methods, etc.).
 * </p>
 * <p>
 * The standard effect hierarchy is:
 * <ul>
 *   <li>{@link BaseSRPEffect} - Standard base for all effects</li>
 *   <li>{@link InfectionEffectBase} extends BaseSRPEffect - For infection effects</li>
 *   <li>{@link ParasiteBuffEffectBase} extends BaseSRPEffect - For parasite buff effects</li>
 * </ul>
 * </p>
 * 
 * @author SubspaceParasite Team
 * @since 1.0.0
 * @deprecated Use {@link BaseSRPEffect} instead
 */
@Deprecated

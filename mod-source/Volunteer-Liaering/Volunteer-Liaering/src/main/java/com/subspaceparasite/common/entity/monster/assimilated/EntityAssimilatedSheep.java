 ...
 */
public class EntityAssimilatedSheep extends EntityFeralBase {
    ...
    public EntityAssimilatedSheep(EntityType<? extends Monster> type, Level world) {
        super(type, world);
        this.setCanPickUpLoot(false);
        this.xpReward = 6;
        this.setHostEntityType("minecraft:sheep");
    }

...
/**
 * EntityHijackedCreeper - Hijacked Creeper
 * Parasite entity of the hijacked tier.
 */
public class EntityHijackedCreeper extends EntityHijackedBase {

    public EntityHijackedCreeper(EntityType<? extends Monster> type, Level level) {
        super(type, level);

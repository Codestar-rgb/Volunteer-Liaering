...
/**
 * EntityBolster - Primitive Bolster
 * Parasite entity of the primitive tier.
 */
public class EntityBolster extends EntityPrimitiveBase {

    public EntityBolster(EntityType<? extends Monster> type, Level level) {
        super(type, level);
        this.parasiteType = ParasiteType.PRI_BOLSTER;
    }

 ...
 */
public class EntityAssimilatedCow extends EntityFeralBase {
    ...
    public EntityAssimilatedCow(EntityType<? extends Monster> type, Level world) {
        super(type, world);
        this.setCanPickUpLoot(false);
        this.xpReward = 8;
        this.setHostEntityType("minecraft:cow");
    }

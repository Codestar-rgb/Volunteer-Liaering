 ...
 * 
 * 属性设计说明：
 * - MAX_HEALTH: 38.0 - 中等偏低血量，特殊攻击型单位
 * - MOVEMENT_SPEED: 0.23 - 较低移动速度
 * - ATTACK_DAMAGE: 7.0 - 中等攻击力
 */
public class EntityLeer extends EntityCrudeBase {

    public EntityLeer(EntityType<? extends EntityCrudeBase> entityType, Level worldIn) {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return EntityCrudeBase.createAttributes()
            .add(Attributes.MAX_HEALTH, 38.0D)      // 中等偏低血量
            .add(Attributes.MOVEMENT_SPEED, 0.23D)  // 较低移动速度

...
/**
 * GeckoLib model for awakened/oroncoAWFL.
 * Generated from MinecraftModelMigrator-Pro-GeckoLib resource mapping.
 */
public class ModelAwakenedOroncoawfl extends GeoModel<EntityAncientDreadnought> {

    private static final ResourceLocation MODEL = new ResourceLocation("subspaceparasite", "gecko_models/awakened/oroncoAWFL.geo.json");
    private static final ResourceLocation TEXTURE = new ResourceLocation("subspaceparasite", "gecko_models/awakened/oroncoAWFL.png");

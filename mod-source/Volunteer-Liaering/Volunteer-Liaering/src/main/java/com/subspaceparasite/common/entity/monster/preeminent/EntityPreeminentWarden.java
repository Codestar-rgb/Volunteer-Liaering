...
/**
 * EntityPreeminentWarden - Preeminent Warden
 * Parasite entity of the preeminent tier.
 */
public class EntityPreeminentWarden extends EntityPreeminentBase {

    public EntityPreeminentWarden(EntityType<? extends Monster> type, Level level) {
        super(type, level);
        this.parasiteType = ParasiteType.WARDEN;
    }

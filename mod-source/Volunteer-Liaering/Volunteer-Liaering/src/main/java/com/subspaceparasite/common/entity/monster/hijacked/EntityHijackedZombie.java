...
/**
 * EntityHijackedZombie - Hijacked Zombie
 * Parasite entity of the hijacked tier.
 */
public class EntityHijackedZombie extends EntityHijackedBase {

    public EntityHijackedZombie(EntityType<? extends Monster> type, Level level) {
        super(type, level);

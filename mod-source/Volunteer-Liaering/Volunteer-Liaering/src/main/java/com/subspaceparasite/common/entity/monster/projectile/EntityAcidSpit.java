...
/**
 * EntityAcidSpit - Acid Spit Projectile
 * Parasite entity of the projectile tier.
 */
public class EntityAcidSpit extends EntityParasiteBase {

    public EntityAcidSpit(EntityType<? extends Monster> type, Level level) {
        super(type, level);

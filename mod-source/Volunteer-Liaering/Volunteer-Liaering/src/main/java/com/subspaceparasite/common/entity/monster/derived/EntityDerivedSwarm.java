...
/**
 * EntityDerivedSwarm - Derived Swarm
 * Parasite entity of the derived tier.
 */
public class EntityDerivedSwarm extends EntityDerivedBase {

    public EntityDerivedSwarm(EntityType<? extends Monster> type, Level level) {
        super(type, level);

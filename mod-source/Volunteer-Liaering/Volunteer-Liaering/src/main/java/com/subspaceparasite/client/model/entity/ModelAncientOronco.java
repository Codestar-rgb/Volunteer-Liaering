...
/**
 * GeckoLib model for ancient/oronco.
 * Generated from MinecraftModelMigrator-Pro-GeckoLib resource mapping.
 */
public class ModelAncientOronco extends GeoModel<EntityAncientColossus> {

    private static final ResourceLocation MODEL = new ResourceLocation("subspaceparasite", "gecko_models/ancient/oronco.geo.json");
    private static final ResourceLocation TEXTURE = new ResourceLocation("subspaceparasite", "gecko_models/ancient/oronco.png");

...
/**
 * EntityBeckonEpic - Beckon Stage IV
 * Parasite entity of the beckon tier.
 */
public class EntityBeckonEpic extends EntityBeckonBase {

    public EntityBeckonEpic(EntityType<? extends Monster> type, Level level) {
        super(type, level);

...
/**
 * EntityEmana - Primitive stage parasite with summoning capabilities.
 */
public class EntityEmana extends EntityPrimitiveBase {
    ...
    public EntityEmana(EntityType<? extends Monster> type, Level world) {
        super(type, world);
        this.xpReward = 10;
        this.setCanPickUpLoot(false);
        this.phaseCreated = EvoPhase.PHASE_1;
        this.parasiteType = ParasiteType.PRI_EMANA;
    }
    ...
    public String getTextureName() {
        return "textures/entity/primitive/subsrp_emana.png";
    }

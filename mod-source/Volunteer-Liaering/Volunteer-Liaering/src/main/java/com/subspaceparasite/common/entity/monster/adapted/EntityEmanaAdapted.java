 ...
 */
public class EntityEmanaAdapted extends EntityAdaptedBase {
    private static final double BASE_HEALTH = 85.0;
    private static final double BASE_ATTACK_DAMAGE = 11.5;
    private static final double BASE_SPEED = 0.24;
    private static final double BASE_ARMOR = 7.5;

    public EntityEmanaAdapted(EntityType<? extends EntityAdaptedBase> entityType, Level worldIn) {

...
/**
 * EntityInfectedPig - Infected Pig
 * Parasite entity of the infected tier.
 */
public class EntityInfectedPig extends EntityInfectedBase {

    public EntityInfectedPig(EntityType<? extends Monster> type, Level level) {
        super(type, level);

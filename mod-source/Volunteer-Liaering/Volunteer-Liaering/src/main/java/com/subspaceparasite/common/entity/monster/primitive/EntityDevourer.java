...
/**
 * EntityDevourer - Primitive Devourer
 * Parasite entity of the primitive tier.
 */
public class EntityDevourer extends EntityPrimitiveBase {

    public EntityDevourer(EntityType<? extends Monster> type, Level level) {
        super(type, level);
        this.parasiteType = ParasiteType.PRI_DEVOURER;
    }

...
/**
 * EntityViscera - Primitive Viscera
 * Parasite entity of the primitive tier.
 */
public class EntityViscera extends EntityPrimitiveBase {

    public EntityViscera(EntityType<? extends Monster> type, Level level) {
        super(type, level);
        this.parasiteType = ParasiteType.PRI_VISCERA;
    }

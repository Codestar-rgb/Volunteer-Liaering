...
/**
 * EntityPrimitiveWolf - Primitive Wolf
 * Parasite entity of the primitive tier.
 */
public class EntityPrimitiveWolf extends EntityPrimitiveBase {

    public EntityPrimitiveWolf(EntityType<? extends Monster> type, Level level) {
        super(type, level);

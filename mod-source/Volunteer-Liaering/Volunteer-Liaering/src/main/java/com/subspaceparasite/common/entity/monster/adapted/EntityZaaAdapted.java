 ...
 */
public class EntityZaaAdapted extends EntityAdaptedBase {
    private static final double BASE_HEALTH = 95.0;
    private static final double BASE_ATTACK_DAMAGE = 12.5;
    private static final double BASE_SPEED = 0.22;
    private static final double BASE_ARMOR = 8.5;

    public EntityZaaAdapted(EntityType<? extends EntityAdaptedBase> entityType, Level worldIn) {

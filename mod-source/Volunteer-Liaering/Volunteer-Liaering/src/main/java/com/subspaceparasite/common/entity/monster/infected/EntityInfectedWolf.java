...
/**
 * EntityInfectedWolf - Infected Wolf
 * Parasite entity of the infected tier.
 */
public class EntityInfectedWolf extends EntityInfectedBase {

    public EntityInfectedWolf(EntityType<? extends Monster> type, Level level) {
        super(type, level);
        this.parasiteType = ParasiteType.SIM_WOLF;
    }

 ...
 */
public class EntityBano extends EntityParasiteBase {
    ...
    public EntityBano(EntityType<? extends EntityBano> type, Level world) {
        super(type, world);
        this.xpReward = 15;
        this.setCanPickUpLoot(false);
        this.phaseCreated = EvoPhase.ONE; // Primitive phase
        this.parasiteType = ParasiteType.BANO;
    }
    ...
    public boolean doHurtTarget(net.minecraft.world.entity.Entity target) {
        ...
        if (result && target instanceof LivingEntity livingTarget) {
            ...
            if (this.getSkinVariant() == 5) {
                livingTarget.addEffect(new MobEffectInstance(ModEffects.VIRUS_EFFECT.get(), 40, 0));
            }
        }
     ...
     * Spawn rule check.
     */
    public static boolean checkSpawnRules(EntityType<? extends EntityBano> type,

...
public class EntityAta extends EntityParasiteBase {
    ...
    public EntityAta(EntityType<? extends EntityParasiteBase> entityType, Level worldIn) {
     ...
     */
    public static boolean checkSpawnRules(EntityType<? extends EntityAta> type,

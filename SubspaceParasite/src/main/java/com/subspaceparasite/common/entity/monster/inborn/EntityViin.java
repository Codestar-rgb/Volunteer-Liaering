 ...
 */
public class EntityViin extends EntityParasiteBase {
    ...
    public EntityViin(EntityType<? extends EntityParasiteBase> entityType, Level worldIn) {
     ...
     */
    public static boolean checkSpawnRules(EntityType<? extends EntityViin> type,

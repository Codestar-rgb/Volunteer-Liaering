...
public class EntityGothol extends EntityParasiteBase {
    ...
    public EntityGothol(EntityType<? extends EntityParasiteBase> entityType, Level worldIn) {
     ...
     */
    public static boolean checkSpawnRules(EntityType<? extends EntityGothol> type,

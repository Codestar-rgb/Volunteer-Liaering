...
public class EntityMor extends EntityParasiteBase {
    ...
    public EntityMor(EntityType<? extends EntityParasiteBase> entityType, Level worldIn) {
     ...
     */
    public static boolean checkSpawnRules(EntityType<? extends EntityMor> type,

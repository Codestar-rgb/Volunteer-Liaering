...
/**
 * EntityNuuh - Inborn stage parasite with large size and high health pool.
 * <p>
 * Original SRP 1.12.2: EntityNuuh in inborn stage.
 * Modernized for Forge 1.20.1 with component-based architecture.
 * <p>
 * Stats (configurable):
 * - Health: 100.0 - Highest durability among inborn parasites
 * - Attack Damage: 11.0 - High damage output
 * - Speed: 0.20 - Moderate movement speed despite large size
 * - Armor: 10.0 - Very high armor protection
 * <p>
 * Behavior:
 * - Massive tank unit capable of absorbing significant damage
 * - Powerful melee attacks with wide reach
 * - Targets non-infected entities aggressively
 */
public class EntityNuuh extends EntityParasiteBase {

    private static final double BASE_HEALTH = 100.0;
    private static final double BASE_ATTACK_DAMAGE = 11.0;
    private static final double BASE_SPEED = 0.20;
    private static final double BASE_ARMOR = 10.0;
    private static final double BASE_KNOCKBACK_RESISTANCE = 0.65;

    public EntityNuuh(EntityType<? extends EntityParasiteBase> entityType, Level worldIn) {
    ...
    protected void registerGoals() {
        ...
        // Melee attack behavior with powerful strikes
    ...
    protected SoundEvent getAmbientSound() {
        return ModSounds.SUBSRP_ENTITY_NUUH_AMBIENT.get();
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource damageSourceIn) {
        return ModSounds.SUBSRP_ENTITY_NUUH_HURT.get();
    }

    @Override
    protected SoundEvent getDeathSound() {
        return ModSounds.SUBSRP_ENTITY_NUUH_DEATH.get();
    }
    ...
    /**
     * Creates attribute supplier for EntityNuuh.
    ...
    /**
     * Spawn rule check for EntityNuuh.
     */
    public static boolean checkSpawnRules(EntityType<? extends EntityNuuh> type,

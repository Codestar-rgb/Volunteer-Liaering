...
public class EntityKol extends EntityParasiteBase {
    ...
    public EntityKol(EntityType<? extends EntityParasiteBase> entityType, Level worldIn) {
     ...
     */
    public static boolean checkSpawnRules(EntityType<? extends EntityKol> type,

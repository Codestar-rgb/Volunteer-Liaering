 ...
 */
public class EntityBanoAdapted extends EntityParasiteBase {
    ...
    public EntityBanoAdapted(EntityType<? extends EntityParasiteBase> entityType, Level worldIn) {
        super(entityType, worldIn);
        this.xpReward = 25;
        this.setPhaseCreated(EvoPhase.THREE);
    }
     ...
     */
    public static boolean checkSpawnRules(EntityType<? extends EntityBanoAdapted> type,

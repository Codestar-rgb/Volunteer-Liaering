...
/**
 * EntityLodo - Inborn stage parasite (note: also exists as Crude stage variant).
 * <p>
 * Original SRP 1.12.2: EntityLodo in inborn stage.
 * Modernized for Forge 1.20.1 with component-based architecture.
 * <p>
 * 
 * Known for ambush tactics and stealth approaches against unsuspecting prey.
 * <p>
 * Stats (configurable):
 * - Health: 45.0 - Moderate durability for early-stage combat
 * - Attack Damage: 7.0 - Moderate damage output
 * - Speed: 0.28 - High movement speed for hit-and-run tactics
 * - Armor: 4.0 - Light armor protection
 * <p>
 * Behavior:
 * - Fast melee attacker specializing in quick strikes
 * - Can evolve to Crude stage under certain conditions
...
public class EntityLodo extends EntityParasiteBase {
    ...
    public EntityLodo(EntityType<? extends EntityParasiteBase> entityType, Level worldIn) {
    ...
    protected SoundEvent getAmbientSound() {
        return ModSounds.SUBSRP_ENTITY_LODO_AMBIENT.get();
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource damageSourceIn) {
        return ModSounds.SUBSRP_ENTITY_LODO_HURT.get();
    }

    @Override
    protected SoundEvent getDeathSound() {
        return ModSounds.SUBSRP_ENTITY_LODO_DEATH.get();
    }
    ...
    /**
     * Creates attribute supplier for EntityLodo (Inborn variant).
    ...
    /**
     * Spawn rule check for EntityLodo (Inborn variant).
     */
    public static boolean checkSpawnRules(EntityType<? extends EntityLodo> type,

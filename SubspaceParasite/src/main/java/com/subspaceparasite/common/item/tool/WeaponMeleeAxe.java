 ...
 * Ported from original SRP WeaponMeleeAxe.
 */
public class WeaponMeleeAxe extends WeaponToolMeleeBase {
    ...
    public Item getNextTier() {
        // Return sentient version if this is the normal axe
        if (this == ModItems.WEAPON_AXE.get()) {
            return ModItems.WEAPON_AXE_SENTIENT.get();
        }
        return null;
    }

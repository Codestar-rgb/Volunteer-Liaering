...
/**
 * GeckoLib renderer for EntityEmana (Primitive stage parasite).
 * Handles rendering with GeckoLib animations, textures, and effects.
 */
public class RenderEmanaGeo extends GeoEntityRenderer<EntityEmana> {

    private static final ResourceLocation DEFAULT_TEXTURE = 
        new ResourceLocation("subspaceparasite", "primitive/emana.png");

    public RenderEmanaGeo(EntityRendererProvider.Context context) {
        super(context, new ModelParasiteGeo<>("primitive/emana", "primitive/emana.png"));
        // Add auto-glowing layer for emissive parts
        this.addRenderLayer(new AutoGlowingGeoLayer<>(this));
    }

    @Override
    public void preRender(PoseStack poseStack, EntityEmana entity, float partialTick, 
    ...
    @Override
    public RenderType getRenderType(EntityEmana entity, float partialTick, PoseStack poseStack,
                                   MultiBufferSource bufferSource, VertexConsumer buffer,
    ...
    @Override
    protected float getDeathMaxRotation(EntityEmana entity) {
        return entity.getDeathMaxRotation();
    }

    @Override
    public ResourceLocation getTextureLocation(EntityEmana entity) {

...
/**
 * GeckoLib renderer for EntityGim (Primitive stage parasite).
 * Handles rendering with GeckoLib animations, textures, and effects.
 */
public class RenderGimGeo extends GeoEntityRenderer<EntityGim> {

    private static final ResourceLocation DEFAULT_TEXTURE = 
        new ResourceLocation("subspaceparasite", "primitive/gim.png");

    public RenderGimGeo(EntityRendererProvider.Context context) {
        super(context, new ModelParasiteGeo<>("primitive/gim", "primitive/gim.png"));
        // Add auto-glowing layer for emissive parts
        this.addRenderLayer(new AutoGlowingGeoLayer<>(this));
    }

    @Override
    public void preRender(PoseStack poseStack, EntityGim entity, float partialTick, 
    ...
    @Override
    public RenderType getRenderType(EntityGim entity, float partialTick, PoseStack poseStack,
                                   MultiBufferSource bufferSource, VertexConsumer buffer,
    ...
    @Override
    protected float getDeathMaxRotation(EntityGim entity) {
        return entity.getDeathMaxRotation();
    }

    @Override
    public ResourceLocation getTextureLocation(EntityGim entity) {

...
/**
 * GeckoLib renderer for EntityHull (Primitive stage parasite).
 * Handles rendering with GeckoLib animations, textures, and effects.
 */
public class RenderHullGeo extends GeoEntityRenderer<EntityHull> {

    private static final ResourceLocation DEFAULT_TEXTURE = 
        new ResourceLocation("subspaceparasite", "primitive/hull.png");

    public RenderHullGeo(EntityRendererProvider.Context context) {
        super(context, new ModelParasiteGeo<>("primitive/hull", "primitive/hull.png"));
        // Add auto-glowing layer for emissive parts
        this.addRenderLayer(new AutoGlowingGeoLayer<>(this));
    }

    @Override
    public void preRender(PoseStack poseStack, EntityHull entity, float partialTick, 
    ...
    @Override
    public RenderType getRenderType(EntityHull entity, float partialTick, PoseStack poseStack,
                                   MultiBufferSource bufferSource, VertexConsumer buffer,
    ...
    @Override
    protected float getDeathMaxRotation(EntityHull entity) {
        return entity.getDeathMaxRotation();
    }

    @Override
    public ResourceLocation getTextureLocation(EntityHull entity) {

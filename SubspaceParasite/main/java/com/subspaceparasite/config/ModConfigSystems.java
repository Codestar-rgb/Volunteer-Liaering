...
public class ModConfigSystems {
    ...
    public static int getPhaseKillThreshold(EvoPhase phase) {
        return switch (phase) {
            case ONE -> ModConfig.EVOLUTION.phase1KillThreshold.get();
            case TWO -> ModConfig.EVOLUTION.phase2KillThreshold.get();
            case THREE -> ModConfig.EVOLUTION.phase3KillThreshold.get();
            case FOUR -> ModConfig.EVOLUTION.phase4KillThreshold.get();
            case FIVE -> ModConfig.EVOLUTION.phase5KillThreshold.get();

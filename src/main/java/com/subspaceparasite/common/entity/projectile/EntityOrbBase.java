 ...
 */
public class EntityOrbBase extends ThrowableProjectile implements GeoEntity {
    ...
    protected void onHitEntity(EntityHitResult result) {
        // Default: no special entity interaction. Subclasses should override.
    }
    ...
    /** Returns the base damage of this orb before multipliers. Override in subclasses. */

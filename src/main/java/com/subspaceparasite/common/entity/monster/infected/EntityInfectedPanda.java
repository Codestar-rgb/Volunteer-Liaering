...
/**
 * EntityInfectedPanda - Infected Panda
 * Parasite entity of the infected tier.
 */
public class EntityInfectedPanda extends EntityInfectedBase {

    public EntityInfectedPanda(EntityType<? extends Monster> type, Level level) {
        super(type, level);

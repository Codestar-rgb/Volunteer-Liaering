...
/**
 * EntityInfectedRavager - Infected Ravager
 * Parasite entity of the infected tier.
 */
public class EntityInfectedRavager extends EntityInfectedBase {

    public EntityInfectedRavager(EntityType<? extends Monster> type, Level level) {
        super(type, level);
        this.parasiteType = ParasiteType.SIM_DRAGONE;
    }

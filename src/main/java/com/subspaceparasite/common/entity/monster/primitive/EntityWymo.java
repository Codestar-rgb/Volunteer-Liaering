 ...
 */
public class EntityWymo extends EntityPrimitiveBase {
    ...
    public EntityWymo(EntityType<? extends Monster> type, Level world) {
        super(type, world);
        this.xpReward = 10;
     ...
     * Overrides base class to provide Wymo-specific cold biome behavior.
     */
    @Override

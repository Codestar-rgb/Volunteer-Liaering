...
/**
 * EntityInfectedEvoker - Infected Evoker
 * Parasite entity of the infected tier.
 */
public class EntityInfectedEvoker extends EntityInfectedBase {

    public EntityInfectedEvoker(EntityType<? extends Monster> type, Level level) {
        super(type, level);

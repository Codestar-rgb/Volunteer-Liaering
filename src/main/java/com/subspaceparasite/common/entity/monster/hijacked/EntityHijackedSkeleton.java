...
/**
 * EntityHijackedSkeleton - Hijacked Skeleton
 * Parasite entity of the hijacked tier.
 */
public class EntityHijackedSkeleton extends EntityHijackedBase {

    public EntityHijackedSkeleton(EntityType<? extends Monster> type, Level level) {
        super(type, level);

 ...
 */
public class EntityInfectedHuman extends EntityInfectedBase {
    ...
    public EntityInfectedHuman(EntityType<? extends Monster> type, Level world) {
        super(type, world);
    ...
    protected void registerGoals() {
        ...
        // NOTE: Infected humans should NOT target other parasites
        // Previous entry targeting EntityParasiteBase was a bug — removed
    }
    ...
    public void tick() {
        ...
        if (!this.level().isClientSide) {
            // Check sun burning
            boolean burning = this.isSunBurnTick();

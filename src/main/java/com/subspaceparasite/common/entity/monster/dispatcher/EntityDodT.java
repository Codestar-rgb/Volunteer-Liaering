...
/**
 * EntityDodT - Dispatcher Tendril
 * Parasite entity of the dispatcher tier.
 */
public class EntityDodT extends EntityDispatcherBase {

    public EntityDodT(EntityType<? extends Monster> type, Level level) {
        super(type, level);
        this.parasiteType = ParasiteType.DISPATCHER_TEN;
    }

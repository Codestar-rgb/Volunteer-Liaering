...
/**
 * EntityInfectedFox - Infected Fox
 * Parasite entity of the infected tier.
 */
public class EntityInfectedFox extends EntityInfectedBase {

    public EntityInfectedFox(EntityType<? extends Monster> type, Level level) {
        super(type, level);

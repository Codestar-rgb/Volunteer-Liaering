...
/**
 * EntityManducater - Primitive Manducater
 * Parasite entity of the primitive tier.
 */
public class EntityManducater extends EntityPrimitiveBase {

    public EntityManducater(EntityType<? extends Monster> type, Level level) {
        super(type, level);
        this.parasiteType = ParasiteType.PRI_MANDUCATER;
    }

...
/**
 * EntityInfectedHusk - Infected Husk
 * Parasite entity of the infected tier.
 */
public class EntityInfectedHusk extends EntityInfectedBase {

    public EntityInfectedHusk(EntityType<? extends Monster> type, Level level) {
        super(type, level);

...
/**
 * EntitySporeCloud - Spore Cloud Projectile
 * Parasite entity of the projectile tier.
 */
public class EntitySporeCloud extends EntityParasiteBase {

    public EntitySporeCloud(EntityType<? extends Monster> type, Level level) {
        super(type, level);

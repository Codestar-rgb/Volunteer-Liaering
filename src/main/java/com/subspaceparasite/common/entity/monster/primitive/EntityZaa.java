...
/**
 * 虚空行者 - Primitive Stage Parasite
 * 特性：短距离传送
 * 行为：相位移动
 */
public class EntityZaa extends EntityParasiteBase {

    public EntityZaa(EntityType<? extends EntityParasiteBase> entityType, Level worldIn) {
        super(entityType, worldIn);
        this.xpReward = 10;
        this.setPhase(EvoPhase.PRIMITIVE);
        this.setParasiteType(ParasiteType.PRIM_ZAA);
    }

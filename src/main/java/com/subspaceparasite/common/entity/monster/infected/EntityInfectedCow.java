 ...
 * - Armor: 3.0
 */
public class EntityInfectedCow extends EntityParasiteBase {
    ...
    public EntityInfectedCow(EntityType<? extends EntityInfectedCow> type, Level world) {
        super(type, world);
    ...
    private void attemptInfect(net.minecraft.world.entity.LivingEntity target) {
        ...
        if (infectionComponent != null) {
            infectionComponent.applyInfection(target, 0.35f);
        }
    }
    ...
    public boolean shouldBurnInSun() {
        return false; // Infected animals don't burn in sunlight
    }

...
/**
 * EntityEndermanAdapted - Adapted Enderman
 * Parasite entity of the adapted tier.
 */
public class EntityEndermanAdapted extends EntityAdaptedBase {

    public EntityEndermanAdapted(EntityType<? extends Monster> type, Level level) {
        super(type, level);
        this.parasiteType = ParasiteType.ADA_DEVOURER;
    }

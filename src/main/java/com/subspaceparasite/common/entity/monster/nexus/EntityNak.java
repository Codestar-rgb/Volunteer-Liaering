...
/**
 * EntityNak - Nak (Seizer)
 * Parasite entity of the nexus tier.
 */
public class EntityNak extends EntityStationaryBase {

    public EntityNak(EntityType<? extends Monster> type, Level level) {
        super(type, level);
        this.parasiteType = ParasiteType.SEIZER;
    }

...
/**
 * EntityVoidOrb - Void Orb Projectile
 * Parasite entity of the misc tier.
 */
public class EntityVoidOrb extends EntityParasiteBase {

    public EntityVoidOrb(EntityType<? extends Monster> type, Level level) {
        super(type, level);

...
public class EntityVenkrolSIV extends EntityDeterrentBase {
    ...
    private void scanForInfectedEntities() {
        List<EntityParasiteBase> nearbyParasites = this.level().getEntitiesOfClass(
    ...
    protected void customServerAiStep() {
        ...
        // updateSwingTime() was removed in MC 1.20.1; swing animation is handled by LivingEntity.tick()
    }

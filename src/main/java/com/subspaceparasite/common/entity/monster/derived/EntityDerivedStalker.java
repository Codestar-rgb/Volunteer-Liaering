...
/**
 * EntityDerivedStalker - Derived Stalker
 * Parasite entity of the derived tier.
 */
public class EntityDerivedStalker extends EntityDerivedBase {

    public EntityDerivedStalker(EntityType<? extends Monster> type, Level level) {
        super(type, level);

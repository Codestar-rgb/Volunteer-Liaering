...
/**
 * EntityNormas - Normas (Inborn Rupter)
 * Parasite entity of the inborn tier.
 */
public class EntityNormas extends EntityInbornBase {

    public EntityNormas(EntityType<? extends Monster> type, Level level) {
        super(type, level);
        this.parasiteType = ParasiteType.RUPTER;
    }

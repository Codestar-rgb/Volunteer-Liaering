...
/**
 * EntityAssimilatedSheep - The assimilated sheep entity (Feral stage).
 */
public class EntityAssimilatedSheep extends EntityParasiteBase {

    private static final EntityDataAccessor<Integer> ASSIMILATION_PROGRESS =
            SynchedEntityData.defineId(EntityAssimilatedSheep.class, EntityDataSerializers.INT);

    private static final double BASE_HEALTH = 18.0;
    ...
    public EntityAssimilatedSheep(EntityType<? extends EntityAssimilatedSheep> type, Level world) {
        super(type, world);
    ...
    public boolean doHurtTarget(net.minecraft.world.entity.Entity target) {
        ...
        if (result && target instanceof net.minecraft.world.entity.LivingEntity living) {
            ...
            this.playSound(ModSounds.ASSIMILATED_SHEEP_ATTACK.get(), 1.0f, 1.0f);
        }
    ...
    protected SoundEvent getAmbientSound() {
        return ModSounds.ASSIMILATED_SHEEP_IDLE.get();
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource source) {
        return ModSounds.ASSIMILATED_SHEEP_HURT.get();
    }

    @Override
    protected SoundEvent getDeathSound() {
        return ModSounds.ASSIMILATED_SHEEP_DEATH.get();
    }

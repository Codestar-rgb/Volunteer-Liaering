...
/**
 * EntityTozon - Primitive Tozon
 * Parasite entity of the primitive tier.
 */
public class EntityTozon extends EntityPrimitiveBase {

    public EntityTozon(EntityType<? extends Monster> type, Level level) {
        super(type, level);
        this.parasiteType = ParasiteType.PRI_TOZON;
    }

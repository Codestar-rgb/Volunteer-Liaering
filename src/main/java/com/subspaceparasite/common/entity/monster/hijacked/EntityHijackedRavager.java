...
/**
 * EntityHijackedRavager - Hijacked Ravager
 * Parasite entity of the hijacked tier.
 */
public class EntityHijackedRavager extends EntityHijackedBase {

    public EntityHijackedRavager(EntityType<? extends Monster> type, Level level) {
        super(type, level);

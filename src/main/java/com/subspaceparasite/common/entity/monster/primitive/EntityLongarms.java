...
/**
 * EntityLongarms - Primitive Longarms
 * Parasite entity of the primitive tier.
 */
public class EntityLongarms extends EntityPrimitiveBase {

    public EntityLongarms(EntityType<? extends Monster> type, Level level) {
        super(type, level);
        this.parasiteType = ParasiteType.PRI_LONGARMS;
    }

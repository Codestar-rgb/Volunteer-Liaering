...
/**
 * EntityArachnida - Primitive Arachnida
 * Parasite entity of the primitive tier.
 */
public class EntityArachnida extends EntityPrimitiveBase {

    public EntityArachnida(EntityType<? extends Monster> type, Level level) {
        super(type, level);
        this.parasiteType = ParasiteType.PRI_ARACHNIDA;
    }

...
/**
 * EntityLeemB - Rooter Spore
 * Parasite entity of the rooter tier.
 */
public class EntityLeemB extends EntityRooterBase {

    public EntityLeemB(EntityType<? extends Monster> type, Level level) {
        super(type, level);
        this.parasiteType = ParasiteType.ROOTER_BALL;
    }

...
/**
 * EntityHijackedWitch - Hijacked Witch
 * Parasite entity of the hijacked tier.
 */
public class EntityHijackedWitch extends EntityHijackedBase {

    public EntityHijackedWitch(EntityType<? extends Monster> type, Level level) {
        super(type, level);

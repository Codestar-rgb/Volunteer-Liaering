...
/**
 * EntityVermin - Primitive Vermin
 * Parasite entity of the primitive tier.
 */
public class EntityVermin extends EntityPrimitiveBase {

    public EntityVermin(EntityType<? extends Monster> type, Level level) {
        super(type, level);
        this.parasiteType = ParasiteType.PRI_VERMIN;
    }

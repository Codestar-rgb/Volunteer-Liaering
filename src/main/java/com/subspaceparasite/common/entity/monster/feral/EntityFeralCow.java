...
/**
 * EntityFeralCow - Feral cow parasite with enhanced charging behavior and pack tactics.
 * Based on original SRP EntityFerCow attributes and mechanics.
 */
public class EntityFeralCow extends EntityParasiteBase {
    ...
    public EntityFeralCow(EntityType<? extends EntityFeralCow> type, Level world) {
        super(type, world);
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new MeleeAttackGoal(this, BASE_SPEED * 1.5, true));
    ...
    public boolean doHurtTarget(net.minecraft.world.entity.Entity target) {
        ...
        if (result && target instanceof net.minecraft.world.entity.LivingEntity living) {
            ...
            this.playSound(ModSounds.FERAL_COW_ATTACK.get(), 1.0f, this.getVoicePitch());
        }
    ...
    private void attemptInfect(net.minecraft.world.entity.LivingEntity target) {
        ...
        if (infectionComponent != null) {
            infectionComponent.applyInfection(target, 0.50f);
        }
    }

    @Override
    protected SoundEvent getAmbientSound() {
        return ModSounds.FERAL_COW_IDLE.get();
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource source) {
        return ModSounds.FERAL_COW_HURT.get();
    }

    @Override
    protected SoundEvent getDeathSound() {
        return ModSounds.FERAL_COW_DEATH.get();
    }

    @Override
    protected void playStepSound(BlockPos pos, net.minecraft.world.level.block.state.BlockState block) {
        this.playSound(ModSounds.PARASITE_STEP.get(), 0.25f, 1.0f);
    }

    @Override
    public ParasiteType getParasiteType() {
        return ParasiteType.FER_COW;
    }
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Monster.createMonsterAttributes()
                ...
                .add(Attributes.KNOCKBACK_RESISTANCE, 0.20);
    }
}

...
/**
 * EntityInfectedDrowned - Infected Drowned
 * Parasite entity of the infected tier.
 */
public class EntityInfectedDrowned extends EntityInfectedBase {

    public EntityInfectedDrowned(EntityType<? extends Monster> type, Level level) {
        super(type, level);

...
/**
 * EntityHijackedEvoker - Hijacked Evoker
 * Parasite entity of the hijacked tier.
 */
public class EntityHijackedEvoker extends EntityHijackedBase {

    public EntityHijackedEvoker(EntityType<? extends Monster> type, Level level) {
        super(type, level);

...
/**
 * EntityInfectedBee - Infected Bee
 * Parasite entity of the infected tier.
 */
public class EntityInfectedBee extends EntityInfectedBase {

    public EntityInfectedBee(EntityType<? extends Monster> type, Level level) {
        super(type, level);

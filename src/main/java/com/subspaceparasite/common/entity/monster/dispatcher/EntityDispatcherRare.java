...
/**
 * EntityDispatcherRare - Dispatcher Stage III
 * Parasite entity of the dispatcher tier.
 */
public class EntityDispatcherRare extends EntityDispatcherBase {

    public EntityDispatcherRare(EntityType<? extends Monster> type, Level level) {
        super(type, level);
        this.parasiteType = ParasiteType.DISPATCHER_SIII;
    }

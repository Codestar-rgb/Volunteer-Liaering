 ...
 */
public class EntityCanra extends EntityPrimitiveBase {
    ...
    public EntityCanra(EntityType<? extends Monster> type, Level world) {
        super(type, world);
        this.xpReward = 12;
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new ParasiteFlightAttackGoal(this, 20.0, false, 20));

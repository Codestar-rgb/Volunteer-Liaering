...
/**
 * EntityVirulentShot - Virulent Shot Projectile
 * Parasite entity of the projectile tier.
 */
public class EntityVirulentShot extends EntityParasiteBase {

    public EntityVirulentShot(EntityType<? extends Monster> type, Level level) {
        super(type, level);

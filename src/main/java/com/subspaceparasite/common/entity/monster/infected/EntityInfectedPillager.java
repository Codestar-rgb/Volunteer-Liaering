...
/**
 * EntityInfectedPillager - Infected Pillager
 * Parasite entity of the infected tier.
 */
public class EntityInfectedPillager extends EntityInfectedBase {

    public EntityInfectedPillager(EntityType<? extends Monster> type, Level level) {
        super(type, level);

...
public class ModEntities {
    ...
    public static final RegistryObject<EntityType<EntityCanra>> PRIMITIVE_CANRA = ENTITIES.register("primitive_canra",
        () -> EntityType.Builder.of(EntityCanra::new, MobCategory.MONSTER).sized(1.0F, 2.6F).build(SubspaceParasite.MOD_ID + ":primitive_canra"));
    public static final RegistryObject<EntityType<EntityEmana>> PRIMITIVE_EMANA = ENTITIES.register("primitive_emana",
        () -> EntityType.Builder.of(EntityEmana::new, MobCategory.MONSTER).sized(0.9F, 2.4F).build(SubspaceParasite.MOD_ID + ":primitive_emana"));
    public static final RegistryObject<EntityType<EntityGim>> PRIMITIVE_GIM = ENTITIES.register("primitive_gim",
        () -> EntityType.Builder.of(EntityGim::new, MobCategory.MONSTER).sized(0.8F, 2.0F).build(SubspaceParasite.MOD_ID + ":primitive_gim"));
    public static final RegistryObject<EntityType<EntityHull>> PRIMITIVE_HULL = ENTITIES.register("primitive_hull",
        () -> EntityType.Builder.of(EntityHull::new, MobCategory.MONSTER).sized(1.2F, 3.0F).build(SubspaceParasite.MOD_ID + ":primitive_hull"));
    public static final RegistryObject<EntityType<EntityIki>> PRIMITIVE_IKI = ENTITIES.register("primitive_iki",
        () -> EntityType.Builder.of(EntityIki::new, MobCategory.MONSTER).sized(1.0F, 2.5F).build(SubspaceParasite.MOD_ID + ":primitive_iki"));
    public static final RegistryObject<EntityType<EntityLum>> PRIMITIVE_LUM = ENTITIES.register("primitive_lum",
        () -> EntityType.Builder.of(EntityLum::new, MobCategory.MONSTER).sized(0.8F, 2.0F).build(SubspaceParasite.MOD_ID + ":primitive_lum"));
    public static final RegistryObject<EntityType<EntityNogla>> PRIMITIVE_NOGLA = ENTITIES.register("primitive_nogla",
        () -> EntityType.Builder.of(EntityNogla::new, MobCategory.MONSTER).sized(1.0F, 2.2F).build(SubspaceParasite.MOD_ID + ":primitive_nogla"));
    public static final RegistryObject<EntityType<EntityRanrac>> PRIMITIVE_RANRAC = ENTITIES.register("primitive_ranrac",
        () -> EntityType.Builder.of(EntityRanrac::new, MobCategory.MONSTER).sized(1.2F, 2.8F).build(SubspaceParasite.MOD_ID + ":primitive_ranrac"));
    public static final RegistryObject<EntityType<EntityShyco>> PRIMITIVE_SHYCO = ENTITIES.register("primitive_shyco",
        () -> EntityType.Builder.of(EntityShyco::new, MobCategory.MONSTER).sized(1.0F, 2.4F).build(SubspaceParasite.MOD_ID + ":primitive_shyco"));
    public static final RegistryObject<EntityType<EntityWymo>> PRIMITIVE_WYMO = ENTITIES.register("primitive_wymo",
        () -> EntityType.Builder.of(EntityWymo::new, MobCategory.MONSTER).sized(0.8F, 1.8F).build(SubspaceParasite.MOD_ID + ":primitive_wymo"));
    public static final RegistryObject<EntityType<EntityZaa>> PRIMITIVE_ZAA = ENTITIES.register("primitive_zaa",
        () -> EntityType.Builder.of(EntityZaa::new, MobCategory.MONSTER).sized(1.3F, 3.2F).build(SubspaceParasite.MOD_ID + ":primitive_zaa"));

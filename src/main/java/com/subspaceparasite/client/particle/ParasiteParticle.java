...
public class ParasiteParticle extends TextureSheetParticle {
    ...
    /**
     * Factory for RISE_FAST behavior particles (named RiseFactoryProvider to
     * avoid name clash with the RISE_FAST case in the factory pattern).
     */
    public static class RiseFactoryProvider implements net.minecraft.client.particle.ParticleProvider<SimpleParticleType> {
        private final SpriteSet spriteSet;

        public RiseFactoryProvider(SpriteSet spriteSet) {
            this.spriteSet = spriteSet;
        }
        ...
        public ParasiteParticle createParticle(SimpleParticleType type, ClientLevel level,
                                                ...
                                                double xSpeed, double ySpeed, double zSpeed) {
            return new ParasiteParticle(level, x, y, z, xSpeed, ySpeed, zSpeed,
                    BehaviorMode.RISE_FAST, this.spriteSet);
        }
    }
}

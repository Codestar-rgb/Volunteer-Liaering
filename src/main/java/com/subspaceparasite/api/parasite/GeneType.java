 ...
 * <ul>
 *   <li><b>Boolean genes</b> — simple on/off flags (indices 0–10)</li>
 *   <li><b>Float genes</b> — continuous values with a default (indices 0–9)</li>
 * </ul>
...
public enum GeneType {
    ...
    /** Basic resistance — entity has innate damage reduction. */
    BASIC_RESISTANCE(6, "Basic Resistance", true,  0.0f),

    /** Infection boost — entity has enhanced infection spread capability. */
    INFECTION_BOOST(7, "Infection Boost",  true,  0.0f),

    /** Combat mastery — entity has advanced combat capabilities. */
    COMBAT_MASTERY (8, "Combat Mastery",   true,  0.0f),

    /** Ancient power — entity has ancient-tier abilities. */
    ANCIENT_POWER  (9, "Ancient Power",    true,  0.0f),

    /** Hive mind — entity is connected to the hive mind network. */
    HIVE_MIND      (10, "Hive Mind",       true,  0.0f),

    // ────────────────────────────────────────────────────────────────
    //  Float genes (index 0–9)
    // ────────────────────────────────────────────────────────────────
    ...
    /** Adaptation speed — multiplier on adaptation rate in CombatComponent. */
    ADAPTATION_SPEED(8, "Adaptation Speed", false, 1.0f),

    /** Spread range — range bonus for COTH spreading (in blocks). */
    SPREAD_RANGE   (9, "Spread Range",     false, 0.0f);

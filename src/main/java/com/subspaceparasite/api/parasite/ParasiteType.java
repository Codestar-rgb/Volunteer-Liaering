...
public enum ParasiteType implements StringRepresentable {
    ...
    SIM_CREEPER      (0x0E, 1.0f,  12.0f, 2.0f, 0.0f, 0.28f, true,  1, 0, 2, "sim_creeper",      "Sim Creeper"),
    SIM_SKELETON     (0x0F, 1.5f,  16.0f, 2.5f, 0.0f, 0.28f, true,  2, 0, 3, "sim_skeleton",     "Sim Skeleton"),
    SIM_GHAST        (0x3C, 4.0f,  40.0f, 6.0f, 0.0f, 0.30f, true,  5, 2, 5, "sim_ghast",        "Sim Ghast"),
    SIM_PHANTOM      (0x3D, 2.5f,  20.0f, 4.0f, 0.0f, 0.32f, true,  3, 1, 4, "sim_phantom",      "Sim Phantom"),
    ...
    SIM_ZOMBIE       (0x16, 2.0f,  20.0f, 3.0f, 0.0f, 0.30f, true,  2, 0, 3, "sim_zombie",       "Sim Zombie"),
    SIM_SPIDER       (0x17, 1.0f,  12.0f, 2.0f, 0.0f, 0.28f, true,  1, 0, 2, "sim_spider",       "Sim Spider"),
    SIM_CHICKEN      (0x18, 0.5f,  8.0f,  1.0f, 0.0f, 0.25f, true,  1, 0, 2, "sim_chicken",      "Sim Chicken"),
    SIM_IRONGOLEM    (0x19, 3.0f,  40.0f, 7.0f, 4.0f, 0.22f, true,  5, 1, 4, "sim_irongolem",    "Sim Iron Golem"),
    SIM_SNOWGOLEM    (0x1A, 1.0f,  12.0f, 1.5f, 0.0f, 0.25f, true,  1, 0, 2, "sim_snowgolem",    "Sim Snow Golem"),
    SIM_BAT          (0x1B, 0.3f,  6.0f,  1.0f, 0.0f, 0.30f, true,  1, 0, 2, "sim_bat",          "Sim Bat"),
    SIM_BLAZE        (0x1C, 2.5f,  20.0f, 4.0f, 0.0f, 0.30f, true,  3, 0, 3, "sim_blaze",        "Sim Blaze"),
    SIM_WITCH        (0x1D, 2.0f,  20.0f, 3.0f, 0.0f, 0.28f, true,  2, 0, 3, "sim_witch",        "Sim Witch"),
    SIM_RAVAGER      (0x1E, 3.5f,  50.0f, 8.0f, 2.0f, 0.25f, true,  6, 1, 4, "sim_ravager",      "Sim Ravager"),
    SIM_PILLAGER     (0x1F, 2.0f,  20.0f, 3.5f, 0.0f, 0.30f, true,  2, 0, 3, "sim_pillager",     "Sim Pillager"),
    ...
    FER_CREEPER      (0x29, 2.0f, 18.0f,  4.0f, 0.0f, 0.30f, true,  2, 1, 3, "fer_creeper",   "Feral Creeper"),
    FER_SKELETON     (0x2A, 2.5f, 22.0f,  5.0f, 0.0f, 0.30f, true,  3, 1, 3, "fer_skeleton",  "Feral Skeleton"),
    FER_ZOMBIE       (0x2B, 3.0f, 28.0f,  6.0f, 0.0f, 0.32f, true,  4, 1, 4, "fer_zombie",    "Feral Zombie"),
    FER_SPIDER       (0x2C, 2.0f, 18.0f,  4.0f, 0.0f, 0.32f, true,  2, 1, 3, "fer_spider",    "Feral Spider"),
    FER_IRONGOLEM    (0x2D, 5.0f, 60.0f, 10.0f, 8.0f, 0.22f, true,  8, 2, 5, "fer_irongolem", "Feral Iron Golem"),
    ...
    HI_CREEPER       (0x33, 3.5f, 28.0f, 6.0f, 0.0f, 0.30f, true,  5, 2, 4, "hi_creeper",    "Hijacked Creeper"),
    HI_ZOMBIE        (0x34, 3.5f, 30.0f, 6.0f, 2.0f, 0.28f, true,  5, 2, 4, "hi_zombie",     "Hijacked Zombie"),
    HI_SPIDER        (0x35, 3.0f, 24.0f, 5.0f, 0.0f, 0.32f, true,  4, 2, 4, "hi_spider",     "Hijacked Spider"),
    HI_ENDERMAN      (0x36, 4.5f, 60.0f, 10.0f, 4.0f, 0.35f, true,  8, 2, 5, "hi_enderman",   "Hijacked Enderman"),
    HI_WITCH         (0x37, 3.5f, 28.0f, 5.0f, 0.0f, 0.28f, true,  5, 2, 4, "hi_witch",      "Hijacked Witch"),
    HI_PILLAGER      (0x38, 3.5f, 28.0f, 6.0f, 0.0f, 0.30f, true,  5, 2, 4, "hi_pillager",   "Hijacked Pillager"),
    HI_EVOKER        (0x39, 4.0f, 32.0f, 6.0f, 0.0f, 0.28f, true,  6, 2, 5, "hi_evoker",     "Hijacked Evoker"),
    HI_RAVAGER       (0x3A, 5.5f, 80.0f, 12.0f, 8.0f, 0.22f, true,  9, 3, 6, "hi_ravager",    "Hijacked Ravager"),
    SIM_EVOKER       (0x3B, 2.0f, 20.0f, 3.5f, 0.0f, 0.28f, true,  2, 0, 3, "sim_evoker",     "Sim Evoker"),
